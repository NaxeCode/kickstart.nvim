...
local keys = {
    ...
    { '<M-,>', '<Cmd>BufferLineCyclePrev<CR>', desc = 'Previous file tab' },
    { '<M-.>', '<Cmd>BufferLineCycleNext<CR>', desc = 'Next file tab' },
    { '<M-<>', '<Cmd>BufferLineMovePrev<CR>', desc = 'Move file tab left' },
    { '<M->>', '<Cmd>BufferLineMoveNext<CR>', desc = 'Move file tab right' },
