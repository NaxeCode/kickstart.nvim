...
return {
  ...
  keys = {
    ...
    { '<leader>hb', function() run_haxeflixel_task 'HaxeFlixel: build HL debug' end, desc = 'HaxeFlixel: build HL debug' },
    { '<leader>hr', function() run_haxeflixel_task 'HaxeFlixel: run HL debug' end, desc = 'HaxeFlixel: run HL debug' },
    { '<leader>hl', function() run_haxeflixel_task 'HaxeFlixel: build Linux debug' end, desc = 'HaxeFlixel: build Linux debug' },
    { '<leader>hd', function() run_haxeflixel_task 'HaxeFlixel: generate display.hxml' end, desc = 'HaxeFlixel: generate display.hxml' },
    { '<leader>hc', function() run_haxeflixel_task 'Haxe: compile unit tests HL' end, desc = 'Haxe: compile unit tests HL' },
    { '<leader>ht', function() run_haxeflixel_task 'Haxe: run unit tests HL' end, desc = 'Haxe: run unit tests HL' },
  },
}
