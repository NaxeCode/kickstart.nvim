...
function M.setup()
    ...
    vim.keymap.set('n', '<leader>ot', '<cmd>OverseerOpen<cr>', { desc = 'Overseer: Open task list' })
    vim.keymap.set('n', '<leader>oa', '<cmd>OverseerTaskAction<cr>', { desc = 'Overseer: Task action' })
    vim.keymap.set('n', '<leader>os', '<cmd>OverseerShell<cr>', { desc = 'Overseer: Shell task' })
    vim.keymap.set('n', '<leader>xb', function() run_haxeflixel_task 'HaxeFlixel: build HL debug' end, { desc = 'HaxeFlixel: build HL debug' })
    vim.keymap.set('n', '<leader>xr', function() run_haxeflixel_task 'HaxeFlixel: run HL debug' end, { desc = 'HaxeFlixel: run/restart HL debug' })
    vim.keymap.set('n', '<leader>xs', function() stop_haxeflixel_tasks() end, { desc = 'HaxeFlixel: stop running task' })
    vim.keymap.set('n', '<leader>xl', function() run_haxeflixel_task 'HaxeFlixel: build Linux debug' end, { desc = 'HaxeFlixel: build Linux debug' })
    vim.keymap.set('n', '<leader>xd', '<cmd>OverseerToggle<cr>', { desc = 'HaxeFlixel: toggle Overseer dock' })
    vim.keymap.set('n', '<leader>xc', function() run_haxeflixel_task 'Haxe: compile unit tests HL' end, { desc = 'Haxe: compile unit tests HL' })
    vim.keymap.set('n', '<leader>xt', function() run_haxeflixel_task 'Haxe: run unit tests HL' end, { desc = 'Haxe: run unit tests HL' })
end
