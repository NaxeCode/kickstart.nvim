...
assert(by_name.syntax.question == nil, 'syntax question was turned into retrieval practice')
...
assert(by_name.concept.question ~= nil, 'concept help omitted its targeted reasoning question')
...
assert(by_name['project-solution-boundary'].question ~= nil, 'project implementation request omitted retrieval practice')
...
local project_text = (by_name['project-solution-boundary'].explanation .. ' ' .. by_name['project-solution-boundary'].question)
